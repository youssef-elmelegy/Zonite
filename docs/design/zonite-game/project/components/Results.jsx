    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <Eyebrow color={winnerColor} style={{ marginBottom: 18 }}>
            {forfeit ? 'Match Ended' : 'Final Result'}
          </Eyebrow>
        ...
        >
          ...
          <Panel style={{ padding: 24 }}>
            ...
            >
              ...
              >
                {total} cells · {room.width}×{room.height}
              </span>
            </div>
            ...
            <Panel style={{ padding: 20 }}>
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--font-mono)', color: '#fff' }}>
                  {board.filter((x) => x !== null).length} / {total}
                </span>
              </div>
            </Panel>
...
function BoardThumb({ board, room }) {
  ...
  return (
    ...
    >
      <div
        style={{ display: 'grid', gridTemplateColumns: `repeat(${room.width}, ${size}px)`, gap: 1 }}
      >
        {board.map((ownerId, i) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                background: color,
                borderRadius: 1,
                boxShadow: owner ? `0 0 2px ${color}` : 'none',
              }}
            />
          );
        })}
