  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          state === 'own'
            ? '0 0 14px var(--team-blue-soft), inset 0 0 0 2px rgba(255,255,255,0.2)'
            : state === 'opp'
              ? '0 0 14px rgba(247,23,86,0.3), inset 0 0 0 2px rgba(255,255,255,0.18)'
              : canHover && hover
                ? '0 0 12px rgba(253,235,86,0.25)'
                : 'none',
