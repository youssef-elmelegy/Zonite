    ...
    return (
      <div
        style={{
          ...
          gap: 8,
          padding: '8px 14px',
          background: critical ? 'rgba(247,23,86,0.15)' : 'rgba(255,255,255,0.04)',
          border: `1px solid ${critical ? 'var(--fire-red)' : 'var(--border-default)'}`,
          borderRadius: 100,
          fontWeight: 700,
          fontSize: 14,
          color: critical ? 'var(--fire-red)' : 'var(--accent-yellow)',
