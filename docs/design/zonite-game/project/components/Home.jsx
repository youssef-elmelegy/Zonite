  ...
  return (
    ...
    >
          ...
          return (
            <div
              ...
              style={{
                ...
                animation:
                  st !== 'empty'
                    ? `cellPulse ${3 + (i % 4) * 0.5}s ${(i % 7) * 0.3}s infinite`
                    : 'none',
              }}
            />
          );
      ...
      <div style={{ maxWidth: 640, position: 'relative', zIndex: 1 }}>
        ...
        >
          Block-by-block, second-by-second. Assemble your squad, fill the board, and take the round
          before the clock hits zero.
        </p>

        {!joining ? (
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <Btn variant="primary" size="lg" icon={<IconPlus size={18} />} onClick={onCreate}>
              Create Room
            </Btn>
            <Btn
              variant="secondary"
          ...
          >
            <Eyebrow color="var(--accent-yellow)" style={{ marginBottom: 4 }}>
              Enter Room Code
            </Eyebrow>
            <div style={{ display: 'flex', gap: 10, alignItems: 'stretch' }}>
              <input
                ...
                style={{
                  ...
                  border: `1px solid ${err ? 'var(--fire-red)' : 'var(--border-default)'}`,
                  borderRadius: 8,
                  padding: '16px 20px',
                  fontSize: 28,
                  fontWeight: 800,
              ...
              />
              <Btn variant="primary" size="lg" type="submit" icon={<IconArrowRight size={18} />}>
                Join
              </Btn>
            </div>
            {err && (
              <div style={{ color: 'var(--fire-red)', fontSize: 12, fontWeight: 600 }}>{err}</div>
            )}
            <button
              type="button"
              onClick={() => {
